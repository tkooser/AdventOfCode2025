...
{
    if (Find(parent, distance.PointIndex1) != Find(parent, distance.PointIndex2))
    {
        componentCount--;
        if(componentCount == 1)
        {
             long result = (long)x[distance.PointIndex1] * x[distance.PointIndex2];
